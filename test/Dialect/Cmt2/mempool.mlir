...
module {
  cmt2.circuit {
    cmt2.module @ScratchpadMemoryPool(%clk: !firrtl.clock, %rst: !firrtl.uint<1>) {
      ...
      cmt2.instance @inst_mem_b = @memory_mem_b(%clk, %rst) : !firrtl.clock, !firrtl.uint<1> with []
      cmt2.method @burst_read (%addr: !firrtl.uint<64>) -> (!firrtl.uint<64>) attributes {arg_attrs = [], res_attrs = []} {
        ...
        %c1024_ui64 = firrtl.constant 1024 : !firrtl.uint<64>
        %8 = firrtl.sub %addr, %c1024_ui64 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %9 = firrtl.bits %8 63 to 0 : (!firrtl.uint<65>) -> !firrtl.uint<64>
        %c1152_ui64 = firrtl.constant 1152 : !firrtl.uint<64>
        %10 = firrtl.geq %addr, %c1024_ui64 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<1>
        %11 = firrtl.lt %addr, %c1152_ui64 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<1>
        %12 = firrtl.and %10, %11 : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
        %13 = cmt2.call @inst_mem_b @burst_read(%9) : (!firrtl.uint<64>) -> !firrtl.uint<64>
        %c0_ui64_2 = firrtl.constant 0 : !firrtl.uint<64>
        %14 = firrtl.mux(%12, %13, %c0_ui64_2) : (!firrtl.uint<1>, !firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %15 = firrtl.or %7, %14 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<64>
        cmt2.return %15 : !firrtl.uint<64>
      }
      cmt2.method @burst_write (%addr: !firrtl.uint<64>, %data: !firrtl.uint<64>) -> () attributes {arg_attrs = [], res_attrs = []} {
        ...
        %c1024_ui64 = firrtl.constant 1024 : !firrtl.uint<64>
        %2 = firrtl.sub %addr, %c1024_ui64 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %3 = firrtl.bits %2 63 to 0 : (!firrtl.uint<65>) -> !firrtl.uint<64>
        cmt2.call @inst_mem_b @burst_write(%3, %data) : (!firrtl.uint<64>, !firrtl.uint<64>) -> ()
        cmt2.return
      }
    }
    cmt2.module @memory_mem_a(%clk: !firrtl.clock, %rst: !firrtl.uint<1>) {
      ...
      cmt2.instance @bank_wrap_2 = @BankWrapper_mem_a_2(%clk, %rst) : !firrtl.clock, !firrtl.uint<1> with []
      cmt2.instance @bank_wrap_3 = @BankWrapper_mem_a_3(%clk, %rst) : !firrtl.clock, !firrtl.uint<1> with []
      cmt2.method @burst_read (%addr: !firrtl.uint<64>) -> (!firrtl.uint<64>) attributes {arg_attrs = [], res_attrs = []} {
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
        cmt2.return %c1_ui1 : !firrtl.uint<1>
      } {
        ...
        %3 = cmt2.call @bank_wrap_2 @burst_read(%addr) : (!firrtl.uint<64>) -> !firrtl.uint<64>
        %4 = firrtl.or %2, %3 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %5 = cmt2.call @bank_wrap_3 @burst_read(%addr) : (!firrtl.uint<64>) -> !firrtl.uint<64>
        %6 = firrtl.or %4, %5 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<64>
        cmt2.return %6 : !firrtl.uint<64>
      }
      cmt2.method @burst_write (%addr: !firrtl.uint<64>, %data: !firrtl.uint<64>) -> () attributes {arg_attrs = [], res_attrs = []} {
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
        cmt2.return %c1_ui1 : !firrtl.uint<1>
        ...
        cmt2.call @bank_wrap_2 @burst_write(%addr, %data) : (!firrtl.uint<64>, !firrtl.uint<64>) -> ()
        cmt2.call @bank_wrap_3 @burst_write(%addr, %data) : (!firrtl.uint<64>, !firrtl.uint<64>) -> ()
        cmt2.return
      }
    }
    ...
    cmt2.module @BankWrapper_mem_a_0(%clk: !firrtl.clock, %rst: !firrtl.uint<1>) {
      ...
      cmt2.method @burst_read (%addr: !firrtl.uint<64>) -> (!firrtl.uint<64>) attributes {arg_attrs = [], res_attrs = []} {
        ...
        %c4_ui64 = firrtl.constant 4 : !firrtl.uint<64>
        %c0_ui64 = firrtl.constant 0 : !firrtl.uint<64>
        %c2_ui64 = firrtl.constant 2 : !firrtl.uint<64>
        %0 = firrtl.div %addr, %c8_ui64 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %1 = firrtl.rem %0, %c4_ui64 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %2 = firrtl.sub %c0_ui64, %1 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %3 = firrtl.add %2, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<66>
        %4 = firrtl.rem %3, %c4_ui64 : (!firrtl.uint<66>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %5 = firrtl.lt %4, %c2_ui64 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<1>
        %6 = firrtl.sub %c0_ui64, %1 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %7 = firrtl.add %6, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<66>
        %8 = firrtl.rem %7, %c4_ui64 : (!firrtl.uint<66>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %9 = firrtl.sub %0, %8 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %10 = firrtl.div %9, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<65>
        ...
        %c0_ui32_0 = firrtl.constant 0 : !firrtl.uint<32>
        %14 = firrtl.cat %12, %c0_ui32_0 : (!firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<64>
        ...
        %c0_ui64_1 = firrtl.constant 0 : !firrtl.uint<64>
        %17 = firrtl.mux(%5, %16, %c0_ui64_1) : (!firrtl.uint<1>, !firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<64>
    ...
    cmt2.module @BankWrapper_mem_a_1(%clk: !firrtl.clock, %rst: !firrtl.uint<1>) {
      ...
      cmt2.method @burst_read (%addr: !firrtl.uint<64>) -> (!firrtl.uint<64>) attributes {arg_attrs = [], res_attrs = []} {
        ...
        %15 = firrtl.eq %4, %c1_ui64_1 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<1>
        %16 = firrtl.mux(%15, %14, %13) : (!firrtl.uint<1>, !firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %c0_ui64 = firrtl.constant 0 : !firrtl.uint<64>
      ...
      cmt2.method @burst_write (%addr: !firrtl.uint<64>, %data: !firrtl.uint<64>) -> () attributes {arg_attrs = [], res_attrs = []} {
        ...
        %12 = firrtl.bits %data 31 to 0 : (!firrtl.uint<64>) -> !firrtl.uint<32>
        %13 = firrtl.bits %data 63 to 32 : (!firrtl.uint<64>) -> !firrtl.uint<32>
        %c1_ui64_0 = firrtl.constant 1 : !firrtl.uint<64>
        %14 = firrtl.eq %4, %c1_ui64_0 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<1>
        %15 = firrtl.mux(%14, %13, %12) : (!firrtl.uint<1>, !firrtl.uint<32>, !firrtl.uint<32>) -> !firrtl.uint<32>
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
        %c0_ui1 = firrtl.constant 0 : !firrtl.uint<1>
        %16 = firrtl.mux(%5, %c1_ui1, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
    ...
    cmt2.module @BankWrapper_mem_a_2(%clk: !firrtl.clock, %rst: !firrtl.uint<1>) {
      cmt2.instance @mem_bank = @Mem1r1w_w32_a8_d256(%clk, %rst) : !firrtl.clock, !firrtl.uint<1> with []
      cmt2.instance @write_enable_wire = @WireDefault_enable_2 with []
      cmt2.instance @write_data_wire = @WireDefault_data_2 with []
      cmt2.instance @write_addr_wire = @WireDefault_addr_2 with []
      cmt2.method @burst_read (%addr: !firrtl.uint<64>) -> (!firrtl.uint<64>) attributes {arg_attrs = [], res_attrs = []} {
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
        cmt2.return %c1_ui1 : !firrtl.uint<1>
      } {
        ...
        %0 = firrtl.div %addr, %c8_ui64 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %1 = firrtl.rem %0, %c4_ui64 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %2 = firrtl.sub %c2_ui64, %1 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %3 = firrtl.add %2, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<66>
        %4 = firrtl.rem %3, %c4_ui64 : (!firrtl.uint<66>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %5 = firrtl.lt %4, %c2_ui64_0 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<1>
        %6 = firrtl.sub %c2_ui64, %1 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %7 = firrtl.add %6, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<66>
        %8 = firrtl.rem %7, %c4_ui64 : (!firrtl.uint<66>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %9 = firrtl.sub %0, %8 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %10 = firrtl.div %9, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<65>
    ...
    cmt2.module @WireDefault_enable_2 {
      cmt2.instance @inner = @Wire_w1 with []
      cmt2.value @read () -> (!firrtl.uint<1>) attributes {arg_attrs = [], res_attrs = []} {
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
        cmt2.return %c1_ui1 : !firrtl.uint<1>
    ...
    cmt2.module @WireDefault_data_2 {
      cmt2.instance @inner = @Wire_w32 with []
      cmt2.value @read () -> (!firrtl.uint<32>) attributes {arg_attrs = [], res_attrs = []} {
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
        cmt2.return %c1_ui1 : !firrtl.uint<1>
    ...
    cmt2.module @WireDefault_addr_2 {
      cmt2.instance @inner = @Wire_w8 with []
      cmt2.value @read () -> (!firrtl.uint<8>) attributes {arg_attrs = [], res_attrs = []} {
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
        cmt2.return %c1_ui1 : !firrtl.uint<1>
    ...
    cmt2.module @BankWrapper_mem_a_3(%clk: !firrtl.clock, %rst: !firrtl.uint<1>) {
      cmt2.instance @mem_bank = @Mem1r1w_w32_a8_d256(%clk, %rst) : !firrtl.clock, !firrtl.uint<1> with []
      cmt2.instance @write_enable_wire = @WireDefault_enable_3 with []
      cmt2.instance @write_data_wire = @WireDefault_data_3 with []
      cmt2.instance @write_addr_wire = @WireDefault_addr_3 with []
      cmt2.method @burst_read (%addr: !firrtl.uint<64>) -> (!firrtl.uint<64>) attributes {arg_attrs = [], res_attrs = []} {
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
        cmt2.return %c1_ui1 : !firrtl.uint<1>
      } {
        %c8_ui64 = firrtl.constant 8 : !firrtl.uint<64>
        %c4_ui64 = firrtl.constant 4 : !firrtl.uint<64>
        %c3_ui64 = firrtl.constant 3 : !firrtl.uint<64>
        %c2_ui64 = firrtl.constant 2 : !firrtl.uint<64>
        %0 = firrtl.div %addr, %c8_ui64 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %1 = firrtl.rem %0, %c4_ui64 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %2 = firrtl.sub %c3_ui64, %1 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %3 = firrtl.add %2, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<66>
        %4 = firrtl.rem %3, %c4_ui64 : (!firrtl.uint<66>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %5 = firrtl.lt %4, %c2_ui64 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<1>
        %6 = firrtl.sub %c3_ui64, %1 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %7 = firrtl.add %6, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<66>
        %8 = firrtl.rem %7, %c4_ui64 : (!firrtl.uint<66>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %9 = firrtl.sub %0, %8 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %10 = firrtl.div %9, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<65>
    ...
    cmt2.module @WireDefault_enable_3 {
      cmt2.instance @inner = @Wire_w1 with []
      cmt2.value @read () -> (!firrtl.uint<1>) attributes {arg_attrs = [], res_attrs = []} {
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
        cmt2.return %c1_ui1 : !firrtl.uint<1>
    ...
    cmt2.module @WireDefault_data_3 {
      cmt2.instance @inner = @Wire_w32 with []
      cmt2.value @read () -> (!firrtl.uint<32>) attributes {arg_attrs = [], res_attrs = []} {
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
        cmt2.return %c1_ui1 : !firrtl.uint<1>
    ...
    cmt2.module @WireDefault_addr_3 {
      cmt2.instance @inner = @Wire_w8 with []
      cmt2.value @read () -> (!firrtl.uint<8>) attributes {arg_attrs = [], res_attrs = []} {
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
        cmt2.return %c1_ui1 : !firrtl.uint<1>
    ...
    cmt2.module @memory_mem_b(%clk: !firrtl.clock, %rst: !firrtl.uint<1>) {
      cmt2.instance @bank_wrap_0 = @BankWrapper_mem_b_0(%clk, %rst) : !firrtl.clock, !firrtl.uint<1> with []
      cmt2.instance @bank_wrap_1 = @BankWrapper_mem_b_1(%clk, %rst) : !firrtl.clock, !firrtl.uint<1> with []
      cmt2.instance @bank_wrap_2 = @BankWrapper_mem_b_2(%clk, %rst) : !firrtl.clock, !firrtl.uint<1> with []
      cmt2.instance @bank_wrap_3 = @BankWrapper_mem_b_3(%clk, %rst) : !firrtl.clock, !firrtl.uint<1> with []
      cmt2.method @burst_read (%addr: !firrtl.uint<64>) -> (!firrtl.uint<64>) attributes {arg_attrs = [], res_attrs = []} {
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
        cmt2.return %c1_ui1 : !firrtl.uint<1>
      } {
    ...
    cmt2.module.extern.firrtl @Mem1r1w_w64_a7_d128 : @Mem1r1w_w64_a7_d128(%clk: !firrtl.clock, %rst: !firrtl.uint<1>) {
      cmt2.bind.bare %clk, @clock : !firrtl.clock
      cmt2.bind.bare %rst, @reset : !firrtl.uint<1>
      cmt2.bind.method @rd0 : () -> ()[enable = "en", arguments = ["raddr"], results = []] {arg_attrs = [], res_attrs = []}
      cmt2.bind.value @rd1 : () -> ()[ready = "rd1_valid", arguments = [], results = ["rdata"]] {arg_attrs = [], res_attrs = []}
    ...
    cmt2.module @BankWrapper_mem_b_0(%clk: !firrtl.clock, %rst: !firrtl.uint<1>) {
      cmt2.instance @mem_bank = @Mem1r1w_w64_a7_d128(%clk, %rst) : !firrtl.clock, !firrtl.uint<1> with []
      cmt2.instance @write_enable_wire = @WireDefault_enable_0 with []
      cmt2.instance @write_data_wire = @WireDefault_data_0 with []
      cmt2.instance @write_addr_wire = @WireDefault_addr_0 with []
      cmt2.method @burst_read (%addr: !firrtl.uint<64>) -> (!firrtl.uint<64>) attributes {arg_attrs = [], res_attrs = []} {
        ...
        %3 = firrtl.add %2, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<66>
        %4 = firrtl.rem %3, %c4_ui64 : (!firrtl.uint<66>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %5 = firrtl.lt %4, %c1_ui64 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<1>
        %6 = firrtl.sub %c0_ui64, %1 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %7 = firrtl.add %6, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<66>
        %8 = firrtl.rem %7, %c4_ui64 : (!firrtl.uint<66>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %9 = firrtl.sub %0, %8 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %10 = firrtl.div %9, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %11 = firrtl.bits %10 6 to 0 : (!firrtl.uint<65>) -> !firrtl.uint<7>
        cmt2.call @mem_bank @rd0(%11) {arg_attrs = [], res_attrs = []} : (!firrtl.uint<7>) -> ()
        %12 = cmt2.call @mem_bank @rd1() {arg_attrs = [], res_attrs = []} : () -> !firrtl.uint<64>
        %c0_ui64_0 = firrtl.constant 0 : !firrtl.uint<64>
        %13 = firrtl.mux(%5, %12, %c0_ui64_0) : (!firrtl.uint<1>, !firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<64>
        cmt2.return %13 : !firrtl.uint<64>
      }
      cmt2.method @burst_write (%addr: !firrtl.uint<64>, %data: !firrtl.uint<64>) -> () attributes {arg_attrs = [], res_attrs = []} {
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
        cmt2.return %c1_ui1 : !firrtl.uint<1>
        ...
        %10 = firrtl.div %9, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %11 = firrtl.bits %10 6 to 0 : (!firrtl.uint<65>) -> !firrtl.uint<7>
        %12 = firrtl.bits %data 63 to 0 : (!firrtl.uint<64>) -> !firrtl.uint<64>
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
        %c0_ui1 = firrtl.constant 0 : !firrtl.uint<1>
        %13 = firrtl.mux(%5, %c1_ui1, %c0_ui1) : (!firrtl.uint<1>, !firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
        cmt2.call @write_enable_wire @write(%13) {arg_attrs = [], res_attrs = []} : (!firrtl.uint<1>) -> ()
        cmt2.call @write_data_wire @write(%12) {arg_attrs = [], res_attrs = []} : (!firrtl.uint<64>) -> ()
        cmt2.call @write_addr_wire @write(%11) {arg_attrs = [], res_attrs = []} : (!firrtl.uint<7>) -> ()
        cmt2.return
      }
      cmt2.rule @do_bank_write () -> () attributes {arg_attrs = [], res_attrs = []} {
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
    ...
    cmt2.module @BankWrapper_mem_b_1(%clk: !firrtl.clock, %rst: !firrtl.uint<1>) {
      cmt2.instance @mem_bank = @Mem1r1w_w64_a7_d128(%clk, %rst) : !firrtl.clock, !firrtl.uint<1> with []
      cmt2.instance @write_enable_wire = @WireDefault_enable_1 with []
      cmt2.instance @write_data_wire = @WireDefault_data_1 with []
      cmt2.instance @write_addr_wire = @WireDefault_addr_1 with []
      cmt2.method @burst_read (%addr: !firrtl.uint<64>) -> (!firrtl.uint<64>) attributes {arg_attrs = [], res_attrs = []} {
        ...
        %3 = firrtl.add %2, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<66>
        %4 = firrtl.rem %3, %c4_ui64 : (!firrtl.uint<66>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %5 = firrtl.lt %4, %c1_ui64_0 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<1>
        %6 = firrtl.sub %c1_ui64, %1 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        %7 = firrtl.add %6, %c4_ui64 : (!firrtl.uint<65>, !firrtl.uint<64>) -> !firrtl.uint<66>
        %8 = firrtl.rem %7, %c4_ui64 : (!firrtl.uint<66>, !firrtl.uint<64>) -> !firrtl.uint<64>
        %9 = firrtl.sub %0, %8 : (!firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<65>
        ...
        %12 = cmt2.call @mem_bank @rd1() {arg_attrs = [], res_attrs = []} : () -> !firrtl.uint<64>
        %c0_ui64 = firrtl.constant 0 : !firrtl.uint<64>
        %13 = firrtl.mux(%5, %12, %c0_ui64) : (!firrtl.uint<1>, !firrtl.uint<64>, !firrtl.uint<64>) -> !firrtl.uint<64>
        cmt2.return %13 : !firrtl.uint<64>
      }
      cmt2.method @burst_write (%addr: !firrtl.uint<64>, %data: !firrtl.uint<64>) -> () attributes {arg_attrs = [], res_attrs = []} {
        %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
    ...
    cmt2.module @BankWrapper_mem_b_2(%clk: !firrtl.clock, %rst: !firrtl.uint<1>) {
      cmt2.instance @mem_bank = @Mem1r1w_w64_a7_d128(%clk, %rst) : !firrtl.clock, !firrtl.uint<1> with []
      cmt2.instance @write_enable_wire = @WireDefault_enable_2 with []
      cmt2.instance @write_data_wire = @WireDefault_data_2 with []
      cmt2.instance @write_addr_wire = @WireDefault_addr_2 with []
    ...
    cmt2.module @BankWrapper_mem_b_3(%clk: !firrtl.clock, %rst: !firrtl.uint<1>) {
      cmt2.instance @mem_bank = @Mem1r1w_w64_a7_d128(%clk, %rst) : !firrtl.clock, !firrtl.uint<1> with []
      cmt2.instance @write_enable_wire = @WireDefault_enable_3 with []
      cmt2.instance @write_data_wire = @WireDefault_data_3 with []
      cmt2.instance @write_addr_wire = @WireDefault_addr_3 with []
  ...
  firrtl.circuit "Mem1r1w_w32_a8_d256" {
    ...
    firrtl.module @Mem1r1w_w64_a7_d128(in %clock: !firrtl.clock, in %reset: !firrtl.uint<1>, in %en: !firrtl.uint<1>, in %raddr: !firrtl.uint<7>, out %rd1_valid: !firrtl.uint<1>, out %rdata: !firrtl.uint<64>, in %wen: !firrtl.uint<1>, in %waddr: !firrtl.uint<7>, in %wdata: !firrtl.uint<64>) {
      %r = firrtl.reg %clock : !firrtl.clock, !firrtl.uint<1>
      firrtl.matchingconnect %r, %en : !firrtl.uint<1>
      firrtl.matchingconnect %rd1_valid, %r : !firrtl.uint<1>
      %mymemory_r, %mymemory_w = firrtl.mem  Undefined {depth = 128 : i64, name = "mymemory", portNames = ["r", "w"], readLatency = 1 : i32, writeLatency = 1 : i32} : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data flip: uint<64>>, !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data: uint<64>, mask: uint<1>>
      %0 = firrtl.subfield %mymemory_r[addr] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data flip: uint<64>>
      %1 = firrtl.subfield %mymemory_r[en] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data flip: uint<64>>
      %2 = firrtl.subfield %mymemory_r[clk] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data flip: uint<64>>
      %3 = firrtl.subfield %mymemory_r[data] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data flip: uint<64>>
      firrtl.matchingconnect %0, %raddr : !firrtl.uint<7>
      firrtl.matchingconnect %1, %en : !firrtl.uint<1>
      firrtl.matchingconnect %2, %clock : !firrtl.clock
      firrtl.matchingconnect %rdata, %3 : !firrtl.uint<64>
      %4 = firrtl.subfield %mymemory_w[addr] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data: uint<64>, mask: uint<1>>
      %5 = firrtl.subfield %mymemory_w[en] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data: uint<64>, mask: uint<1>>
      %6 = firrtl.subfield %mymemory_w[clk] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data: uint<64>, mask: uint<1>>
      %7 = firrtl.subfield %mymemory_w[data] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data: uint<64>, mask: uint<1>>
      %8 = firrtl.subfield %mymemory_w[mask] : !firrtl.bundle<addr: uint<7>, en: uint<1>, clk: clock, data: uint<64>, mask: uint<1>>
      firrtl.matchingconnect %4, %waddr : !firrtl.uint<7>
      firrtl.matchingconnect %5, %wen : !firrtl.uint<1>
      firrtl.matchingconnect %6, %clock : !firrtl.clock
      firrtl.matchingconnect %7, %wdata : !firrtl.uint<64>
      %c1_ui1 = firrtl.constant 1 : !firrtl.uint<1>
      firrtl.matchingconnect %8, %c1_ui1 : !firrtl.uint<1>
    }
  }
