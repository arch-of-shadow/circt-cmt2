...
"""
Cycle-Precise Timing Example (JIT stacked on PyCMT2)
...
Usage:
    PYTHONPATH=build/tools/circt/python_packages/circt_core:python \\
      python3 examples/JIT/timing.py
"""
...
def main():
    print("=" * 60)
    print("JIT Cycle-Precise Timing Example (stacked on PyCMT2)")
    print("=" * 60)
...
def create_simulatable_timing_circuit():
    ...
    with jit.module(circuit, "TimingComprehensive") as m:
        clk = m.clock()
        rst = m.reset()
