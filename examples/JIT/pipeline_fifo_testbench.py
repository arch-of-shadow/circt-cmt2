...
"""
GAA Pipeline with FIFOs Testbench Example (JIT stacked on PyCMT2).
...
Usage:
    PYTHONPATH=build/tools/circt/python_packages/circt_core:python \\
      python3 examples/JIT/pipeline_fifo_testbench.py
"""
...
def create_pipeline_circuit():
    ...
    with jit.module(circuit, "DataPipeline") as m:
        clk = m.clock()
        rst = m.reset()
...
""")
    ...
    print("\n9. Building and running simulation...")
