...
"""
Diagnostics Example for PyCMT2.
...
Usage:
    cd circt-cmt2/build
    PYTHONPATH=tools/circt/python_packages/circt_core python3 ../examples/PyCMT2/diagnostics_example.py
"""
...
def main():
    print("=" * 70)
    print("PyCMT2 Diagnostics System Demonstration")
    print("=" * 70)
